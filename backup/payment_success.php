<?php
$con = mysqli_connect('localhost', 'sharahaq_sharada', 'sharada@24', 'sharahaq_sharada');
function decryptPaymentId($encrypted)
{
    $key = 'your-secret-key'; // Use the same secure key
...
if (isset($_GET['payment_id'])) {
    ...
    $sql = "SELECT * FROM fees_payment where payment_id='$decryptedPaymentId'";
    $result = mysqli_query($con, $sql);
    $fetch = mysqli_fetch_assoc($result);

    // echo "Payment Successful! Payment ID: " . htmlspecialchars($decryptedPaymentId);
} else {
    header('Location: payment.php?error=Payment not verified');
}
                ...
                <div class="content">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="content-block">
                                                    <img src='./img/SHARADA-LOGO-FINAL-1.jpg'>
                    ...
                    <div class="footer">
                        <table width="100%">
                            <tbody>
                                <tr>
                                    <td class="aligncenter content-block">Questions? Email <a href="mailto:">support@company.inc</a><br><br><a href="index.html">Go Back to Website</a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
