...
<div id="addModal" class="modal fade" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog" role="document">
    <form action="{{ route('admission-form.store')}}" method="POST" enctype="multipart/form-data">
    @csrf
                                ...
                                @foreach($data as $val)
                                    <tr data-id="{{ $val->id }}">
                                        ...
                                        <td data-field="url_name">
                                            <a class="btn btn-outline-secondary btn-sm edit" title="Edit" href="{{ asset($val->url_name) }}">
                                        ...
                                        <td>
                                            ...
                                            {!! Form::open(['route' => ['admission-form.destroy', $val],'method' => 'delete',  'class'=>'d-inline-block dform']) !!}
                                        ...
                                        <div id="designation_edit{{ $val->id }}" class="modal fade" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true" style="display: none;">
                                              <div class="modal-dialog" role="document">
                                                {!! Form::model($val, ['method' => 'PATCH','enctype'=>"multipart/form-data",'route' => ['admission-form.update', $val->id]]) !!}
                                                @csrf
                                                <div class="modal-content">
                                                  <div class="modal-header">
