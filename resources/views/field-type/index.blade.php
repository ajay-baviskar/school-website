...
<div id="addModal" class="modal fade" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog" role="document">
    <form action="{{ route('field-type.store')}}" method="POST" enctype="multipart/form-data">
    @csrf
                                ...
                                @foreach($data as $val)
                                    <tr data-id="{{ $val->id }}">
                                        ...
                                        <td>
                                            ...
                                            {!! Form::open(['route' => ['field-type.destroy', $val],'method' => 'delete',  'class'=>'d-inline-block dform']) !!}
                                        ...
                                        <div id="designation_edit{{ $val->id }}" class="modal fade" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true" style="display: none;">
                                              <div class="modal-dialog" role="document">
                                                {!! Form::model($val, ['method' => 'PATCH','route' => ['field-type.update', $val->id]]) !!}
                                                @csrf
                                                <div class="modal-content">
                                                  <div class="modal-header">
