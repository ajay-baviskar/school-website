            ...
            <div class="card mb-5">
                ...
                <div class="card-body">
                    ...
                    <div class="d-sm-flex flex-wrap">
                        ...
                        <div class="ms-auto">
                            <a href="{{ route('six-users.index') }}" class="btn btn-primary waves-effect waves-light" >Back</a>
                        </div>
                    </div>
                    <br>
                    @endrole
{!! Form::model($user, ['method' => 'PATCH','route' => ['six-users.update', $user->id]]) !!}

<div class="row">
    <div class="col-xs-6 col-sm-6 col-md-6">
        <div class="form-group">
            <strong>Role:</strong>
            {{ Form::select('roles', $roles, ($users->getRoleData)?$users->getRoleData->name:null, [ 'class'=> 'form-control','required'=>true]) }}
        </div>
    </div>
    <div class="col-xs-6 col-sm-6 col-md-6">
        <div class="form-group">
    ...
    <div class="col-lg-6">
        <div class="form-group">
            <input type="hidden" name="6s_users" value="1">
