                            ...
                            <table class="table table-bordered dt-responsive  nowrap w-100 " id="datatable" >
                                ...
                                @foreach($data as $val)
                                    <tr data-id="{{ $val->id }}">
                                        ...
                                        <td data-field="min_score">{{ $val->min_score }}</td>
                                        <td data-field="max_score">{{ $val->max_score }}</td>
                                        ...
                                        <td>
                                            ...
                                            {!! Form::open(['route' => ['ratings.destroy', $val],'method' => 'delete',  'class'=>'d-inline-block dform']) !!}
                                        ...
                                        <div id="designation_edit{{ $val->id }}" class="modal fade" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true" style="display: none;">
                                              <div class="modal-dialog" role="document">
                                                {!! Form::model($val, ['method' => 'PATCH','route' => ['ratings.update', $val->id]]) !!}
                                                @csrf
                                                <div class="modal-content">
                                                  <div class="modal-header">
