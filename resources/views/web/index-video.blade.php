...
<!-- Mirrored from ingridkuhn.com/themes/alphabet-bs5.3/index-video.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Jun 2023 04:39:16 GMT -->
...
<head>
      ...
      <!--[if lt IE 9]>
      <script src="{{url('public')}}/theme/js/respond.js"></script>
      <![endif]-->
      <!-- Bootstrap Core CSS -->
      <link href="{{url('public')}}/theme/css/bootstrap.css" rel="stylesheet" type="text/css">
      <!-- Icon fonts -->
      <link href="{{url('public')}}/theme/fonts/fontawesome/css/all.min.css" rel="stylesheet" type="text/css">
      <link href="{{url('public')}}/theme/fonts/flaticons/flaticon.css" rel="stylesheet" type="text/css">
      <!-- Google fonts -->
      <link href='https://fonts.googleapis.com/css?family=Lato:400,700,800%7CAlegreya+Sans:700,900' rel='stylesheet' type='text/css'>
      <!-- Theme CSS -->
      <link href="{{url('public')}}/theme/css/style.css" rel="stylesheet">
      <!-- Color Style CSS -->
      <link href="{{url('public')}}/theme/styles/maincolors.css" rel="stylesheet">
      <!-- Plugins -->
      <link rel="stylesheet" href="{{url('public')}}/theme/css/plugins.css">
      <!-- Calendar CSS -->
      <link rel="stylesheet" href="{{url('public')}}/theme/css/calendar.css">
      <!-- LayerSlider stylesheet -->
      <link rel="stylesheet" href="{{url('public')}}/theme/layerslider/css/layerslider.css">
      <!-- Favicons-->
      <link rel="apple-touch-icon" sizes="72x72" href="{{url('public')}}/theme/../../apple-touch-icon-72x72.html">
      <link rel="apple-touch-icon" sizes="114x114" href="{{url('public')}}/theme/../../apple-touch-icon-114x114.html">
      <link rel="shortcut icon" href="{{url('public')}}/theme/favicon.ico" type="image/x-icon">
	        <!-- Switcher Only -->
      <link rel="stylesheet" id="switcher-css" type="text/css" href="{{url('public')}}/theme/switcher/css/switcher.css" media="all" />
      <!--Alternate CSS -->
      <link rel="alternate stylesheet" type="text/css" href="{{url('public')}}/theme/styles/maincolors.css" title="funtime" media="all" />
      <link rel="alternate stylesheet" type="text/css" href="{{url('public')}}/theme/styles/playground.css" title="playground" media="all" />
      <link rel="alternate stylesheet" type="text/css" href="{{url('public')}}/theme/styles/games.css" title="games" media="all" />
      <link rel="alternate stylesheet" type="text/css" href="{{url('public')}}/theme/styles/childhood.css" title="childhood" media="all" />
      <link rel="alternate stylesheet" type="text/css" href="{{url('public')}}/theme/styles/school.css" title="school" media="all" />
	  <link rel="alternate stylesheet" type="text/css" href="{{url('public')}}/theme/styles/toddler.css" title="toddler" media="all" />
	   <link rel="alternate stylesheet" type="text/css" href="{{url('public')}}/theme/styles/nanny.css" title="nanny" media="all" />
      <link rel="alternate stylesheet" type="text/css" href="{{url('public')}}/theme/switcher/css/boxed.css" title="boxed" media="all" />
      <link rel="alternate stylesheet" type="text/css" href="{{url('public')}}/theme/switcher/css/full.css" title="full" media="all" />
   ...
   <body id="page-top" class="full" data-bs-spy="scroll" data-bs-target=".navbar-nav">
               ...
               <div class="row">
                  <div class="col-md-12 text-center">
                     <div class="predefined_styles">
                        ...
                        <!-- MODULE #3 -->
                        <a href="{{url('public')}}/theme/playground.html" class="styleswitch"><img src="{{url('public')}}/theme/switcher/images/icons/playground.png" class="rounded-circle" alt="Playground"></a>     
                        <a href="{{url('public')}}/theme/games.html"  class="styleswitch"><img src="{{url('public')}}/theme/switcher/images/icons/games.png" class="rounded-circle" alt="Games"></a>
                        <a href="{{url('public')}}/theme/toddler.html" class="styleswitch"><img src="{{url('public')}}/theme/switcher/images/icons/toddler.png" class="rounded-circle" alt="Toddler"></a>
                        <a href="{{url('public')}}/theme/school.html" class="styleswitch"><img src="{{url('public')}}/theme/switcher/images/icons/school.png" class="rounded-circle" alt="School"></a> 							
                        <a href="{{url('public')}}/theme/childhood.html" class="styleswitch"><img src="{{url('public')}}/theme/switcher/images/icons/childhood.png" class="rounded-circle" alt="Childhood"></a>
                        <a href="{{url('public')}}/theme/nanny.html" class="styleswitch"><img src="{{url('public')}}/theme/switcher/images/icons/nanny.png" class="rounded-circle" alt="Nanny">
						<a href="{{url('public')}}/theme/maincolors.html" class="styleswitch"><img src="{{url('public')}}/theme/switcher/images/icons/maincolors.png" class="rounded-circle" alt="Main Colors"></a>

						<h4 class="mt-4">Page Width</h4>
			   <form>
				...
				<option value="boxed">Boxed</option>
                        ...
                        <a href="{{url('public')}}/theme/index.html" class="btn">Layerslider</a>
                        <a href="{{url('public')}}/theme/index-video.html" class="btn">Video</a>
                     </div>
      ...
      <nav class="navbar navbar-expand-xl fixed-top">
         <div class="container">
            <!-- Logo mobile-->
            <a class="navbar-brand-small page-scroll my-auto d-xl-none" href="{{url('public')}}/theme/index.html">
            <img src="{{url('public')}}/theme/img/logo.png"  alt=""/>
            </a>
            ...
            <div class="collapse navbar-collapse" id="nav-alphabet">
               <ul class="navbar-nav mx-auto">
                  <li class="nav-item home">
                     <a class="nav-link" href="{{url('/index')}}#layerslider">Home</a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                     <a class="nav-link" href="{{url('/index')}}#activities">Activities</a>
                  </li>
				    <!--desktop logo -->
                  <li class="nav-item d-none d-xl-block navbar-brand-centered ">
                     <a href="{{url('/index')}}#page-top">
                     <img src="{{url('public')}}/theme/img/logo.png"  alt=""/>
                     </a>
                  </li>
				    <!--/desktop logo -->
                  ...
                  <li class="nav-item dropdown">
                     <a class="nav-link dropdown-toggle blog-dropdown" href="{{url('/index')}}#" id="sub-menu1" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                     Blog
                     </a>
                     <ul class="dropdown-menu " aria-labelledby="sub-menu1">
                        <li><a class="dropdown-item" href="{{url('public')}}/theme/blog-home.html">Blog</a></li>
                        <li><a class="dropdown-item" href="{{url('public')}}/theme/blog-post.html">Blog Post</a></li>
                     </ul>
                  </li>
                  <!--/nav-item -->
                  <li class="nav-item">
                     <a class="nav-link" href="{{url('/index')}}#prices">Prices</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="{{url('/index')}}#contact">Contact</a>
                  </li>
                  <li class="nav-item dropdown">
                     <a class="nav-link dropdown-toggle page-dropdown" href="{{url('/index')}}#" id="sub-menu2" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                     Pages
                     </a>
                     <ul class="dropdown-menu " aria-labelledby="sub-menu2">
                        <li><a class="dropdown-item" href="{{url('public')}}/theme/sidebar-page.html">Sidebar page</a></li>
                        <li><a class="dropdown-item" href="{{url('public')}}/theme/calendar-page.html">Calendar Page</a></li>
						 <li><a class="dropdown-item" href="{{url('public')}}/theme/index-video.html">Video Home page</a></li>
                        <li><a class="dropdown-item" href="{{url('public')}}/theme/elements-page.html">Elements</a></li>
                     </ul>
                  </li>
                  <!--/nav-item -->
               </ul>
      ...
      <div id="video-header" class="ratio ratio ratio-4x3">
         ...
         <video id="bgvid" class="bottom-0 h-auto" playsinline autoplay muted loop>
            <!-- video -->
            <source src="{{url('public')}}/theme/videos/video1.mp4" type="video/mp4">
         </video>
            ...
            <div class="col-lg-4 offset-lg-1 col-sm-12 d-flex aligns-items-center h-100">
               <div class="video-text my-auto">
                  ...
                  <div class="page-scroll">
                     <!-- Button-->
                     <a class="btn hidden-xs hidden-sm" href="{{url('/index')}}#contact">Contact us</a>
                  </div>
                  <!-- /page-scroll -->			
               </div>
               <!-- /video-text -->
   ...
   <div class="container">
      ...
      <div class="row align-items-center">
         ...
         <div class="col-md-12 col-lg-5 offset-lg-1">
            <!-- Image -->
            <img src="{{url('public')}}/theme/img/services.png" alt="" class="img-fluid ">
         </div>
         <!-- /col-md-12-->
      </div>
      <!-- /row -->
      <div class="row mt-5">
         ...
         <div class="col-lg-4">
            <div class="service float">
               <img src="{{url('public')}}/theme/img/service1.jpg" alt="" class="rounded-circle  img-fluid">
               <h4>Infants</h4>
         ...
         <div class="col-lg-4 res-margin">
            <div class="service float">
               <img src="{{url('public')}}/theme/img/service2.jpg" alt="" class="rounded-circle   img-fluid">
               <h4>Toddlers</h4>
               <p class="mt-3">Lectus placerat a ultricies a,interdum donec eget metus auguen u Fusce mollis imperdiet interdum donec eget metus auguen unc.</p>
            </div>
         </div>
         ...
         <div class="col-lg-4">
            <div class="service float">
               <img src="{{url('public')}}/theme/img/service3.jpg" alt="" class="rounded-circle  img-fluid">
               <h4>Pre School</h4>
               <p class="mt-3">Lectus placerat a ultricies a, interdum donec eget metus auguen u Fusce mollis imperdiet interdum donec eget metus auguen unc.</p>
            </div>
         </div>
   ...
   <div class="container">
      ...
      <div class="col-lg-6 d-inline-block p-3">
         <div class="card text-center ">
            ...
            <div class="page-scroll">
               <!-- Button-->
               <a class="btn" href="{{url('/index')}}#contact">Contact us</a>
            </div>
            <!-- /page-scroll -->
         </div>
         <!-- /card -->
      ...
      <div class="row align-items-center">
         <div class="col-sm-12 col-lg-5">
            ...
            <div id="carousel-about" class="slider-1">
               <div class="item">
                  <img class="img-fluid" src="{{url('public')}}/theme/img/about1.jpg" alt="">
               </div>
               <div class="item">
                  <img class="img-fluid" src="{{url('public')}}/theme/img/about2.jpg" alt="">
               </div>
               <div class="item">
                  <img class="img-fluid" src="{{url('public')}}/theme/img/about3.jpg" alt="">
               </div>
            </div>
         </div>
         <!-- text -->
         ...
         <div class="slider-2">
            ...
            <blockquote>
               <div class="col-md-4 col-lg-4 col-centered">
                  <!-- testimonial image-->
                  <img src="{{url('public')}}/theme/img/testimonial1.jpg" alt="" class="img-fluid rounded-circle mb-5">
               </div>
            ...
            <blockquote>
               <div class="col-md-4 col-lg-4 col-centered">
                  <!-- testimonial image-->
                  <img src="{{url('public')}}/theme/img/testimonial2.jpg" alt="" class="img-fluid rounded-circle mb-5">
               </div>
               <div class="col-md-10 offset-md-1  quote-test text-center">
                  <!-- quote -->
            ...
            <blockquote>
               <div class="col-md-4 col-lg-4 col-centered">
                  <!-- testimonial image-->
                  <img src="{{url('public')}}/theme/img/testimonial3.jpg" alt="" class="img-fluid rounded-circle mb-5">
               </div>
               <div class="col-md-10 offset-md-1 quote-test text-center">
                  <!-- quote -->
...
<div class="parallax-object1 d-none d-lg-block" data-0="opacity:1;"
   ...
   <!-- Image -->
   <img src="{{url('public')}}/theme/img/parallaxobject1.png" alt="">
</div>
<!-- Section Team -->
   ...
   <div class="container">
      ...
      <div class="row team align-items-center">
         <div class="col-lg-6 res-margin">
            <!-- Intro image -->
            <img src="{{url('public')}}/theme/img/teammain.jpg" class="mx-auto img-fluid img-curved" alt=""/>
         </div>
		  <!-- /col-lg -->
      ...
      <div class="row-team">
         <div id="team-slider" class="slider-4 mt-5">
            <div class="col-lg-12">
               <!-- member 1-->
               <div class="team-item">
                  <img src="{{url('public')}}/theme/img/team1.jpg" alt=""/>
            ...
            <div class="col-lg-12">
               <!-- member 2-->
               <div class="team-item">
                  <img src="{{url('public')}}/theme/img/team2.jpg" alt=""/>
                  <div class="team-caption">
            ...
            <div class="col-lg-12">
               <!-- member 3-->
               <div class="team-item">
                  <img src="{{url('public')}}/theme/img/team3.jpg" alt=""/>
                  <div class="team-caption">
            ...
            <div class="col-lg-12">
               <!-- member 3-->
               <div class="team-item">
                  <img src="{{url('public')}}/theme/img/team4.jpg" alt=""/>
                  <div class="team-caption">
            ...
            <div class="col-lg-12">
               <!-- member 3-->
               <div class="team-item">
                  <img src="{{url('public')}}/theme/img/team5.jpg" alt=""/>
                  <div class="team-caption">
            ...
            <div class="col-lg-12">
               <!-- member 3-->
               <div class="team-item">
                  <img src="{{url('public')}}/theme/img/team6.jpg" alt=""/>
                  <div class="team-caption">
      ...
      <div class="tab-content color_block" id="pills-tabContent">
         <div class="tab-pane show active" id="pills-1" role="tabpanel" aria-labelledby="pills-1-tab">
            ...
            <div class="row g-lg-5 align-items-center">
               <div class="col-lg-5">
                  <!-- Activity image-->
                  <img src="{{url('public')}}/theme/img/activity1.jpg" alt="" class="img-fluid rounded-circle">						
               </div>
                <div class="col-lg-7">
                        <!-- Activity text-->
                        <h3>Music Classes</h3>
         ...
         <div class="tab-pane " id="pills-2" role="tabpanel" aria-labelledby="pills-2-tab">
            ...
            <div class="row g-lg-5 align-items-center">
               <div class="col-lg-5">
                  <!-- Activity image-->
                  <img src="{{url('public')}}/theme/img/activity2.jpg" alt="" class="img-fluid rounded-circle">						
               </div>
               <div class="col-lg-7">
                  <!-- Activity text-->
         ...
         <div class="tab-pane" id="pills-3" role="tabpanel" aria-labelledby="pills-3-tab">
            ...
            <div class="row g-lg-5 align-items-center">
               <div class="col-lg-5">
                  <!-- Activity image-->
                  <img src="{{url('public')}}/theme/img/activity3.jpg" alt="" class="img-fluid rounded-circle">						
               </div>
               <div class="col-lg-7">
                  <!-- Activity text-->
                  <h3>Our Lunch</h3>
         ...
         <div class="tab-pane" id="pills-4" role="tabpanel" aria-labelledby="pills-4-tab">
            ...
            <div class="row g-lg-5 align-items-center">
               <div class="col-lg-5">
                  <!-- Activity image-->
                  <img src="{{url('public')}}/theme/img/activity4.jpg" alt="" class="img-fluid rounded-circle">						
               </div>
               <div class="col-lg-7">
                  <!-- Activity text-->
   ...
   <div class="container">
      ...
      <div class="text-center col-md-12">
         <ul class="nav nav-pills justify-content-center cat mb-5" id="gallerytab">
            <li class="nav-item">
               <a class="nav-link active" aria-current="page" href="{{url('/index')}}#"  data-toggle="tab" data-filter="*">All</a>
            </li>
            <li class="nav-item">
               <a class="nav-link" href="{{url('/index')}}#" data-toggle="tab" data-filter=".events">Events</a>
            </li>
            <li class="nav-item">
               <a class="nav-link" href="{{url('/index')}}#" data-toggle="tab" data-filter=".facilities">Our Facilities</a>
            </li>
         </ul>
      </div>
      <!-- Gallery -->
         ...
         <div class="col-md-12">
            <div id="lightbox">
               ...
               <div class="col-sm-6 col-md-6 col-lg-4 events">
                  <div class="portfolio-item">
                     <div class="gallery-thumb">
                        <img class="img-fluid" src="{{url('public')}}/theme/img/gallery1.jpg" alt="">
                        <span class="overlay-mask"></span>
                        <a href="{{url('public')}}/theme/img/gallery1.jpg" class="link centered" title="You can add caption to pictures.">
               ...
               <div class="col-sm-6 col-md-6 col-lg-4 facilities">
                  <div class="portfolio-item">
                     <div class="gallery-thumb">
                        <img class="img-fluid" src="{{url('public')}}/theme/img/gallery2.jpg" alt="">
                        <span class="overlay-mask"></span>
                        <a href="{{url('public')}}/theme/img/gallery2.jpg" class="link centered" title="You can add caption to pictures.">
                        <i class="fa fa-expand"></i></a>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-sm-6 col-md-6 col-lg-4 facilities">
                  <div class="portfolio-item">
                     <div class="gallery-thumb">
                        <img class="img-fluid" src="{{url('public')}}/theme/img/gallery3.jpg" alt="">
                        <span class="overlay-mask"></span>
                        <a href="{{url('public')}}/theme/img/gallery3.jpg" class="link centered" title="You can add caption to pictures.">
                        <i class="fa fa-expand"></i></a>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-sm-6 col-md-6 col-lg-4 events">
                  <div class="portfolio-item">
                     <div class="gallery-thumb">
                        <img class="img-fluid" src="{{url('public')}}/theme/img/gallery4.jpg" alt="">
                        <span class="overlay-mask"></span>
                        <a href="{{url('public')}}/theme/img/gallery4.jpg" class="link centered" title="You can add caption to pictures.">
                        <i class="fa fa-expand"></i></a>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-sm-6 col-md-6 col-lg-4 facilities">
                  <div class="portfolio-item">
                     <div class="gallery-thumb">
                        <img class="img-fluid" src="{{url('public')}}/theme/img/gallery5.jpg" alt="">
                        <span class="overlay-mask"></span>
                        <a href="{{url('public')}}/theme/img/gallery5.jpg" class="link centered" title="You can add caption to pictures.">
                        <i class="fa fa-expand"></i></a>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-sm-6 col-md-6 col-lg-4 facilities">
                  <div class="portfolio-item">
                     <div class="gallery-thumb">
                        <img class="img-fluid" src="{{url('public')}}/theme/img/gallery6.jpg" alt="">
                        <span class="overlay-mask"></span>
                        <a href="{{url('public')}}/theme/img/gallery6.jpg" class="link centered" title="You can add caption to pictures.">
                        <i class="fa fa-expand"></i></a>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-sm-6 col-md-6 col-lg-4 events">
                  <div class="portfolio-item">
                     <div class="gallery-thumb">
                        <img class="img-fluid" src="{{url('public')}}/theme/img/gallery7.jpg" alt="">
                        <span class="overlay-mask"></span>
                        <a href="{{url('public')}}/theme/img/gallery7.jpg" class="link centered" title="You can add caption to pictures.">
                        <i class="fa fa-expand"></i></a>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-sm-6 col-md-6 col-lg-4 events">
                  <div class="portfolio-item">
                     <div class="gallery-thumb">
                        <img class="img-fluid" src="{{url('public')}}/theme/img/gallery8.jpg" alt="">
                        <span class="overlay-mask"></span>
                        <a href="{{url('public')}}/theme/img/gallery8.jpg" class="link centered" title="You can add caption to pictures.">
                        <i class="fa fa-expand"></i></a>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-sm-6 col-md-6 col-lg-4 facilities">
                  <div class="portfolio-item">
                     <div class="gallery-thumb">
                        <img class="img-fluid" src="{{url('public')}}/theme/img/gallery9.jpg" alt="">
                        <span class="overlay-mask"></span>
                        <a href="{{url('public')}}/theme/img/gallery9.jpg" class="link centered" title="You can add caption to pictures.">
                        <i class="fa fa-expand"></i></a>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-sm-6 col-md-6 col-lg-4 facilities">
                  <div class="portfolio-item">
                     <div class="gallery-thumb">
                        <img class="img-fluid" src="{{url('public')}}/theme/img/gallery10.jpg" alt="">
                        <span class="overlay-mask"></span>
                        <a href="{{url('public')}}/theme/img/gallery10.jpg" class="link centered" title="You can add caption to pictures.">
                        <i class="fa fa-expand"></i></a>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-sm-6 col-md-6 col-lg-4 facilities">
                  <div class="portfolio-item">
                     <div class="gallery-thumb">
                        <img class="img-fluid" src="{{url('public')}}/theme/img/gallery11.jpg" alt="">
                        <span class="overlay-mask"></span>
                        <a href="{{url('public')}}/theme/img/gallery11.jpg" class="link centered" title="You can add caption to pictures.">
                        <i class="fa fa-expand"></i></a>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-sm-6 col-md-6 col-lg-4 facilities">
                  <div class="portfolio-item">
                     <div class="gallery-thumb">
                        <img class="img-fluid" src="{{url('public')}}/theme/img/gallery12.jpg" alt="">
                        <span class="overlay-mask"></span>
                        <a href="{{url('public')}}/theme/img/gallery12.jpg" class="link centered" title="You can add caption to pictures.">
                        <i class="fa fa-expand"></i></a>
                     </div>
                  </div>
               </div>
      ...
      <div class="col-lg-12 color_block">
         <div class="slider-3">
            ...
            <div class="blog-preview">
               <!-- Blog image -->
               <img src="{{url('public')}}/theme/img/blogprev1.jpg" class="img-fluid" alt="" />
               <div class="latest-caption text-center">
                  <a href="{{url('public')}}/theme/blog-post.html">
                     <h4>Mother's Day</h4>
                  </a>
                  <!-- Post Info -->
                  <div class="post-info">
                     <p><i class="fa-regular fa-clock"></i>Aug 24, 2015 at 9:00 PM</p>
                     <p><i class="fa fa-user"></i>by <a href="{{url('/index')}}#">Mary Jane</a></p>
                     <!-- Post features -->
                     <p><i class="fa-solid fa-comment"></i><a href="{{url('/index')}}#">5 Comments</a></p>
                  </div>
                  ...
                  <!-- Button-->
                  <a class="btn" href="{{url('public')}}/theme/blog-post.html">Read More</a>
               </div>
            </div>
            <!-- /blog-preview -->
            <!-- Blog item 2 -->
            <div class="blog-preview col-md-12">
               <!-- Blog image -->
               <img src="{{url('public')}}/theme/img/blogprev2.jpg" class="img-fluid" alt="" />
               <div class="latest-caption text-center">
                  <a href="{{url('public')}}/theme/blog-post.html">
                  ...
                  <div class="post-info">
                     ...
                     <p><i class="fa fa-user"></i>by <a href="{{url('/index')}}#">Mary Jane</a></p>
                     <!-- Post features -->
                     <p><i class="fa-solid fa-comment"></i><a href="{{url('/index')}}#">8 Comments</a></p>
                  </div>
                  <p>Lorem av ipsum dolor sit amet, dorem ipsuem ore consectetur adipisicing elit. Lorem isuem amorem semprem Ratione, voluptatem lorem ipsuet alpacas dolorem animi nisi autem...</p>
                  <!-- Button-->
                  <a class="btn" href="{{url('public')}}/theme/blog-post.html">Read More</a>
            ...
            <div class="blog-preview col-md-12">
               <!-- Blog image -->
               <img src="{{url('public')}}/theme/img/blogprev3.jpg" class="img-fluid" alt="" />
               <div class="latest-caption text-center">
                  <a href="{{url('public')}}/theme/blog-post.html">
                  ...
                  <div class="post-info">
                     ...
                     <p><i class="fa fa-user"></i>by <a href="{{url('/index')}}#">Mary Jane</a></p>
                     <!-- Post features -->
                     <p><i class="fa-solid fa-comment"></i><a href="{{url('/index')}}#">12 Comments</a></p>
                  </div>
                  <p>Lorem av ipsum dolor sit amet, dorem ipsuem ore consectetur adipisicing elit. Lorem isuem amorem semprem Ratione, voluptatem lorem ipsuet alpacas dolorem animi nisi autem...</p>
                  <!-- Button-->
                  <a class="btn" href="{{url('public')}}/theme/blog-post.html">Read More</a>
            ...
            <div class="blog-preview col-md-12">
               <!-- Blog image -->
               <img src="{{url('public')}}/theme/img/blogprev4.jpg" class="img-fluid" alt="" />
               <div class="latest-caption text-center">
                  <a href="{{url('public')}}/theme/blog-post.html">
                     <h4>New Classroom</h4>
                  </a>
                  ...
                  <div class="post-info">
                     ...
                     <p><i class="fa fa-user"></i>by <a href="{{url('/index')}}#">Mary Jane</a></p>
                     <!-- Post features -->
                     <p><i class="fa-solid fa-comment"></i><a href="{{url('/index')}}#">6 Comments</a></p>
                  </div>
                  <p>Lorem av ipsum dolor sit amet, dorem ipsuem ore consectetur adipisicing elit. Lorem isuem amorem semprem Ratione, voluptatem lorem ipsuet alpacas dolorem animi nisi autem...</p>
                  <!-- Button-->
                  <a class="btn" href="{{url('public')}}/theme/blog-post.html">Read More</a>
            ...
            <div class="blog-preview col-md-12">
               <!-- Blog image -->
               <img src="{{url('public')}}/theme/img/blogprev5.jpg" class="img-fluid" alt="" />
               <div class="latest-caption text-center">
                  <a href="{{url('public')}}/theme/blog-post.html">
                  ...
                  <div class="post-info">
                     ...
                     <p><i class="fa fa-user"></i>by <a href="{{url('/index')}}#">Mary Jane</a></p>
                     <!-- Post features -->
                     <p><i class="fa-solid fa-comment"></i><a href="{{url('/index')}}#">1 Comment</a></p>
                  </div>
                  <p>Lorem av ipsum dolor sit amet, dorem ipsuem ore consectetur adipisicing elit. Lorem isuem amorem semprem Ratione, voluptatem lorem ipsuet alpacas dolorem animi nisi autem...</p>
                  <!-- Button-->
                  <a class="btn" href="{{url('public')}}/theme/blog-post.html">Read More</a>
            ...
            <div class="blog-preview col-md-12">
               <!-- Blog image -->
               <img src="{{url('public')}}/theme/img/blogprev6.jpg" class="img-fluid" alt="" />
               <div class="latest-caption text-center">
                  <a href="{{url('public')}}/theme/blog-post.html">
                     <h4>Toddler Care</h4>
                  </a>
                  ...
                  <div class="post-info">
                     ...
                     <p><i class="fa fa-user"></i>by <a href="{{url('/index')}}#">Mary Jane</a></p>
                     <!-- Post features -->
                     <p><i class="fa-solid fa-comment"></i><a href="{{url('/index')}}#">81 features</a></p>
                  </div>
                  <p>Lorem av ipsum dolor sit amet, dorem ipsuem ore consectetur adipisicing elit. Lorem isuem amorem semprem Ratione, voluptatem lorem ipsuet alpacas dolorem animi nisi autem...</p>
                  <!-- Button-->
                  <a class="btn" href="{{url('public')}}/theme/blog-post.html">Read More</a>
...
<div class="parallax-object3 d-none d-lg-block" data-0="opacity:1;"
   ...
   <!-- Image -->
   <img src="{{url('public')}}/theme/img/parallaxobject3.png" alt="">
</div>
<!-- Section Prices -->
   ...
   <div class="container text-center ">
      <div class="col-lg-6 offset-lg-6 p-3">
         <div class="card">
            ...
            <!-- Button -->
            <div class="page-scroll">
               <a class="btn" href="{{url('/index')}}#about">About Us</a>
            </div>
            <!--/page-scroll -->
         </div>
         <!--/card -->
      ...
      <div class="row">
         ...
         <div class="col-lg-4 text-center">
            ...
            <div class="contact-info">
               <p><i class="flaticon-back"></i><a href="{{url('public')}}/theme/mailto:youremailaddress">daycare@site.com</a></p>
...
<footer>
      ...
      <div class="row">
         ...
         <div class="col-lg-3 text-center res-margin my-auto">
            ...
            <div id="mc_embed_signup">
               ...
               <form action="https://cloudwaysapps.us20.list-manage.com/subscribe/post?u=2bc190484536d73c66c28d6a8&amp;id=8ea081e025" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                  <div id="mc_embed_signup_scroll">
                     ...
                     <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_2bc190484536d73c66c28d6a8_8ea081e025" tabindex="-1" value=""></div>
         ...
         <div class="col-lg-6 res-margin my-auto">
            <a href="{{url('/index')}}#page-top"><img src="{{url('public')}}/theme/img/logo.png"  alt="" class="d-block mx-auto"></a>
            <!-- social-icons -->	
            <div class="social-media text-center mt-3">
               <a href="{{url('/index')}}#" title=""><i class="fa-brands fa-twitter"></i></a>
               <a href="{{url('/index')}}#" title=""><i class="fa-brands fa-facebook-f"></i></a>
               <a href="{{url('/index')}}#" title=""><i class="fa-brands fa-linkedin"></i></a>
               <a href="{{url('/index')}}#" title=""><i class="fa-brands fa-pinterest"></i></a>
               <a href="{{url('/index')}}#" title=""><i class="fa-brands fa-instagram"></i></a>
            </div>
         </div>
         <!-- /col-lg- -->
         <!-- Opening Hours -->
   ...
   <!-- / container -->
   <hr>
   <p class="credits">Designed by  <a href="{{url('public')}}/theme/http://www.ingridkuhn.com/">Ingrid Kuhn</a></p>
   <!-- /container -->
   <!-- Go To Top Link -->
   <div class="page-scroll d-none d-lg-block">
      <a href="{{url('/index')}}#page-top" class="back-to-top"><i class="fa fa-angle-up"></i></a>
   </div>
</footer>
<!-- /footer ends -->
<!-- Core JavaScript Files -->
<script src="{{url('public')}}/theme/js/jquery.min.js"></script>
<script src="{{url('public')}}/theme/js/bootstrap.min.js"></script>
<!-- Main Js -->
<script src="{{url('public')}}/theme/js/main.js"></script>
<!--Other Plugins -->
<script src="{{url('public')}}/theme/js/plugins.js"></script>

 <!-- Swicther -->
      <script src="{{url('public')}}/theme/switcher/js/dmss.js"></script>
      <script src="{{url('public')}}/theme/switcher/js/fixes.js"></script>
...
<!-- GreenSock -->
<script src="{{url('public')}}/theme/layerslider/js/greensock.js" ></script>
<!-- LayerSlider script files -->
<script src="{{url('public')}}/theme/layerslider/js/layerslider.transitions.js" ></script>
<script src="{{url('public')}}/theme/layerslider/js/layerslider.kreaturamedia.jquery.js" ></script>
<script src="{{url('public')}}/theme/layerslider/js/layerslider.load.js" ></script>
</body>

<!-- Mirrored from ingridkuhn.com/themes/alphabet-bs5.3/index-video.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Jun 2023 04:39:17 GMT -->
</html>
