                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                {{ Form::select('priority', ['Critical'=>'Critical','High'=>'High','Medium'=>'Medium','Low'=>'Low'], 'Low', [ 'class'=> 'form-control','required'=>true]) }}
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <input name="img[]" class="form-control" type="file" accept="image/*,.pdf" multiple="multiple">
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                                {{ Form::label('text', 'Image Description', ['class' => 'form-control-label']) }}
                                {!! Form::textarea('img_desc', null, ['class' => 'form-control']) !!}
                            </div>
                        </div>
                    </div>
