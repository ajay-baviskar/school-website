...
<div>
  ...
  <h4 style="font-weight: normal !important;">Dear {{$user->name}} </h4>
    <p>This is a reminder for the ticket which has been assigned to you and pending at your end, please login to https://sahyoug.kusumgar.com to update the same.</p>
