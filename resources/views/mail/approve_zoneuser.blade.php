                ...
                <div class="table-responsive">
                    <table class="table table-nowrap mb-0">
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">Assigned To : {{$val->getCreatedBy->name }}</th>
                            </tr>
                            <tr>
                                <th scope="row">Feedback by Coordinator : @if($val->getFeedbackData && $val->getFeedbackData->getCoardinator) {{$val->getFeedbackData->getCoardinator->name}} @endif</th>
                            </tr>
                            <tr>
